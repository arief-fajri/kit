<script lang="ts">
	...
	$: customStyles = (() => {
		...
		if (computedStyling.backgroundColor)
			styles.push(`--card-bg: ${computedStyling.backgroundColor}`);
		if (computedStyling.borderColor) styles.push(`--card-border: ${computedStyling.borderColor}`);
		if (computedStyling.shadowColor)
			styles.push(`--card-shadow-color: ${computedStyling.shadowColor}`);
		if (computedStyling.borderRadius)
			styles.push(`--card-border-radius: ${computedStyling.borderRadius}`);
