...
| ------------------------------------------------------- | ---- | ------- | ----------- |
| _(No core props - Card uses only styling and behavior)_ |      |         |             |
...
<Card behavior={{ clickable: true }} ariaLabel="Click to view details" on:click={handleCardClick}>
...
<Card clickable ariaLabel="View product details" on:click={handleViewDetails}>
	<h3>Product Card</h3>
...
```typescript
import type { CardProps, CardStyling, CardBehavior } from '@rief/kit';
