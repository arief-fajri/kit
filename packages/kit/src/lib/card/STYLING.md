...
:root {
  ...
  --card-shadow-elevated: 0 1px 3px 0 var(--card-shadow-color), 0 1px 2px -1px var(--card-shadow-color);
  --card-shadow-elevated-hover: 0 4px 6px -1px var(--card-shadow-color), 0 2px 4px -2px var(--card-shadow-color);
...
.card-lift:hover {
  ...
  --card-shadow-hover: 0 20px 25px -5px var(--card-shadow-color), 0 10px 10px -5px var(--card-shadow-color);
}
