...
[data-theme="dark"] {
  ...
  --dropdown-elevated-shadow:
    rgba(0, 0, 0, 0.4) 0px 8px 12px -2px,
...
.nav-dropdown {
  ...
  --dropdown-shadow: 
    rgba(102, 126, 234, 0.3) 0px 8px 32px,
    rgba(118, 75, 162, 0.2) 0px 4px 16px;
}
...
/* Semantic variants */
.dropdown-primary { --dropdown-bg: var(--color-primary); --dropdown-text-color: white; }
.dropdown-success { --dropdown-bg: var(--color-success); --dropdown-text-color: white; }
.dropdown-warning { --dropdown-bg: var(--color-warning); --dropdown-text-color: white; }
.dropdown-danger { --dropdown-bg: var(--color-danger); --dropdown-text-color: white; }
