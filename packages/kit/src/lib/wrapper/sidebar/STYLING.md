...
:root {
  ...
  --sidebar-drag-handle-border: 1px solid var(--sidebar-drag-handle-border-color, rgba(59, 130, 246, 0.2));
...
2. **Layer Your Overrides**: Use CSS specificity wisely - global defaults, theme overrides, component-specific styles
   ...
   [data-theme="dark"] { /* Theme overrides */ }
   .nav-sidebar { /* Component-specific */ }
   ```
