...
>
	<div
		class="sort-header__content {className} {colClass}"
		class:sort-header__content--hoverable={!disable}
	>
		<slot>
...
<style>
  ...
  */
	...
	.sort-header {
		...
		transition: background-color var(--sort-header-transition-duration)
			var(--sort-header-transition-timing);
	}
