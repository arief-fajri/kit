...
| `--accordion-padding-x`    | _computed_ | Computed horizontal padding (set by size variant, can be overridden) |
| `--accordion-padding-y`    | _computed_ | Computed vertical padding (set by size variant, can be overridden)   |
...
| `--accordion-font-size`        | _computed_ | Computed font size (set by size variant, can be overridden) |
...
.accordion-success {
	--accordion-text-hover: var(--color-success);
}
.accordion-warning {
	--accordion-text-hover: var(--color-warning);
}
.accordion-danger {
	--accordion-text-hover: var(--color-danger);
}
