...
<style lang="postcss">
	...
	.btn--semantic-primary {
		...
		--btn-bg-outlined-hover: var(
			--btn-semantic-primary-bg-outlined-hover,
			rgba(59, 130, 246, 0.05)
		);
		--btn-bg-outlined-active: var(
			--btn-semantic-primary-bg-outlined-active,
			rgba(59, 130, 246, 0.1)
		);
	...
	.btn--semantic-secondary {
		...
		--btn-bg-outlined-hover: var(
			--btn-semantic-secondary-bg-outlined-hover,
			rgba(107, 114, 128, 0.05)
		);
		--btn-bg-outlined-active: var(
			--btn-semantic-secondary-bg-outlined-active,
	...
	.btn--semantic-success {
		...
		--btn-bg-outlined-hover: var(
			--btn-semantic-success-bg-outlined-hover,
			rgba(16, 185, 129, 0.05)
		);
		--btn-bg-outlined-active: var(
			--btn-semantic-success-bg-outlined-active,
			rgba(16, 185, 129, 0.1)
		);
	...
	.btn--semantic-warning {
		...
		--btn-bg-outlined-hover: var(
			--btn-semantic-warning-bg-outlined-hover,
			rgba(245, 158, 11, 0.05)
		);
		--btn-bg-outlined-active: var(
			--btn-semantic-warning-bg-outlined-active,
			rgba(245, 158, 11, 0.1)
		);
