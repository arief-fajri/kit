...
```svelte
<div data-theme="dark">
  <Tags bind:tags={tags} placeholder="Add tags..." />
</div>
```
...
```svelte
<Tags bind:tags={tags} wrapperClass="tags-success" placeholder="Success tags..." />
<Tags bind:tags={tags} wrapperClass="tags-warning" placeholder="Warning tags..." />
<Tags bind:tags={tags} wrapperClass="tags-error" placeholder="Error tags..." />
```
...
```svelte
<!-- Usage in components -->
<Tags bind:tags={tags} wrapperClass="tags-primary" placeholder="Primary tags..." />
<Tags bind:tags={tags} wrapperClass="tags-success" placeholder="Success tags..." />
<Tags bind:tags={tags} wrapperClass="tags-error" placeholder="Error tags..." />
```
