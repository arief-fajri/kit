...
<div class="calendar-grid">
  <!-- Weekday headers -->
  <div class="calendar-grid__header" class:calendar-grid__header--with-week-numbers={showWeekNumbers}>
    {#if showWeekNumbers}
  ...
  <div class="calendar-grid__body">
    {#each Array(weekCount) as _, weekIndex}
      <div class="calendar-grid__week" class:calendar-grid__week--with-week-numbers={showWeekNumbers}>
        {#if showWeekNumbers}
