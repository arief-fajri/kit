<script lang="ts">
  ...
  const handleDateChange = (event: CustomEvent<DatePickerChangeEvent>) => {
    ...
    if (computedBehavior.closeOnSelect && changeMode === "single") {
      openDropdown = false;
    } else if (computedBehavior.closeOnSelect && changeMode === "range" && (newValue as DateRangeValue)[1]) {
      openDropdown = false;
    }
  };
...
>
  ...
  <div class="input-date-picker__container {computedStyling.wrapperClass}" style={computedStyling.wrapperStyle}>
    <button
      type="button"
...
<style>
  ...
  .input-date-picker__trigger {
    ...
    width: 100%;
    padding: var(--input-date-picker-padding-y-md, 0.5rem) var(--input-date-picker-padding-x-md, 0.75rem);
  ...
  .input-date-picker__trigger:focus-visible {
    ...
    box-shadow: var(--input-date-picker-shadow-focus, var(--shadow-focus, 0 0 0 3px rgb(59 130 246 / 0.1)));
  }
  ...
  .input-date-picker--sm .input-date-picker__trigger {
    ...
    padding: var(--input-date-picker-padding-y-sm, 0.375rem) var(--input-date-picker-padding-x-sm, 0.5rem);
  ...
  .input-date-picker--lg .input-date-picker__trigger {
    ...
    padding: var(--input-date-picker-padding-y-lg, 0.625rem) var(--input-date-picker-padding-x-lg, 1rem);
