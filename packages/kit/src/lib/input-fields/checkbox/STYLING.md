...
/* Semantic variants */
.checkbox-primary { --checkbox-border-color: var(--color-primary); }
.checkbox-success { --checkbox-border-color: var(--color-success); }
.checkbox-warning { --checkbox-border-color: var(--color-warning); }
.checkbox-danger { --checkbox-border-color: var(--color-danger); }
