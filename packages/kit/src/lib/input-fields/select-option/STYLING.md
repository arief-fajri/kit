...
/>
<SelectOption {options} label="Danger Select" styling={{ wrapperClass: 'select-option-danger' }} />
```
...
```svelte
<SelectOption {options} label="Dynamic Theme" styling={{ wrapperStyle: selectStyles }} />
```
...
<SelectOption {options} label="Dark Theme Select" styling={{ variant: 'filled' }} />
```
