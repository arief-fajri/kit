...
/* Semantic variants */
.radiobox-primary { --radiobox-primary: var(--color-primary); }
.radiobox-success { --radiobox-primary: var(--color-success); }
.radiobox-warning { --radiobox-primary: var(--color-warning); }
.radiobox-error { --radiobox-primary: var(--color-error); }
