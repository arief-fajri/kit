...
```svelte
<InputText label="Dynamic Theme Input" styling={{ wrapperStyle: inputStyles }} />
```
...
```svelte
<!-- Usage in components -->
<InputText label="Primary Input" styling={{ wrapperClass: 'input-text-primary' }} />

<InputText label="Success Input" styling={{ wrapperClass: 'input-text-success' }} />
...
<div data-theme="dark">
	<InputText label="Dark Theme Input" placeholder="Enter text in dark mode..." />
</div>
```
